            ...
            <div className="post-artikel">
                <div className="form pb-3 border-bottom">
                    ...
                    <div className="form-group row my-3">
                        ...
                        <div className="col-sm-10">
                            <textarea name="body" id="body" rows="3" className="form-control" ref="isiArtikel"
                            ></textarea>
                        </div>
                    </div>
                ...
                {this.state.listArtikel.map((artikel) => {
                    ...
                    return (
                        <Post key={artikel.uid} judul={artikel.title} isi={artikel.body} idArtikel={artikel.uid} hapusArtikel={this.handleHapusArtikel}
                        />
                    );
                })}
            </div>
